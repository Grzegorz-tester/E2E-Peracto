...
(async () => {
  ...
  console.log("BUTTONS after click:", JSON.stringify(buttons.map(b => b.trim()).filter(Boolean)));

  await page.screenshot({ path: "/private/tmp/claude-502/-Users-ghajduk-Downloads-Tests-e2e/98e3e6cc-4bdb-4694-a03c-e087ec58a3b0/scratchpad/after-click-hit-div.png", fullPage: true });
