@regression
Feature: Logged-in checkout - VAT number field (FR)

  # Migrated from P3Playwright watco/tests/basket-checkout/fr/logged-in-checkout-vat-field.test.ts
  ...
  Scenario: Has a saved VAT number - field is pre-populated and editable
    ...
    And the "VAT number" should equal the value "FRCD987654321"
