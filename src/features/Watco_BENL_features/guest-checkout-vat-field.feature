@regression
Feature: Guest checkout - VAT number field (BE-NL)

  # Migrated from P3Playwright watco/tests/basket-checkout/benl/guest-checkout-vat-field.test.ts
  # Behaves like NL (Pay on Account hidden until VAT applied, a business-
  # customer comment, domestic zero-rating).
